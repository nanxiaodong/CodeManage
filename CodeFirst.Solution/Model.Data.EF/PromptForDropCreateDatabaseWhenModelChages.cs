...
namespace Model.Data.EF
{
    public class PromptForDropCreateDatabaseWhenModelChages<TContext> : IDatabaseInitializer<TContext> where TContext : DbContext
    {
        public void InitializeDatabase(TContext context)
        {
            ...
            //If the database exists and doesn't match the model then prompt for input
            if (exists)
            {
            ...
            // Database either didn't exist or it didn't match the model and the user chose to delete it
